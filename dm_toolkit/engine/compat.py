...
class EngineCompat:
    ...
    @staticmethod
    def ParallelRunner_play_games(runner: Any, initial_states: List[GameState], evaluator_func: Union[Callable, Any], temperature: float, add_noise: bool, threads: int) -> List[Any]:
