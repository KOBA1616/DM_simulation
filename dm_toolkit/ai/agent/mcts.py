...
# =============================================================================
# WARNING: DEPRECATED PYTHON IMPLEMENTATION
# =============================================================================
# The pure Python MCTS implementation below is deprecated and commented out.
# Please use the C++ native implementation `dm_ai_module.MCTS` for better
# performance and compatibility with the core engine.
# =============================================================================

class MCTS:
    def __init__(self, *args, **kwargs) -> None:
        raise RuntimeError(
            "This Python MCTS implementation is deprecated and disabled. "
            "Please use `dm_ai_module.MCTS` (C++) instead for performance reasons."
        )
