...
# =============================================================================
# DEPRECATION WARNING:
# This Python implementation of MCTS is DEPRECATED and has been replaced by the
# C++ native implementation (`dm_ai_module.MCTS`).
#
# The Python implementation caused performance bottlenecks and type inconsistencies.
# All simulation and agent logic should now use the C++ engine directly.
# =============================================================================

class MCTS:
    def __init__(self, *args, **kwargs):
        raise RuntimeError(
            "This Python MCTS implementation is deprecated. "
            "Please use the C++ implementation `dm_ai_module.MCTS` instead."
        )

# The original Python implementation is commented out below for reference.
...
#
#
# class MCTS_Python_Implementation: # Renamed to avoid name collision with dummy MCTS class if uncommented
