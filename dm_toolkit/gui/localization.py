...
TRANSLATIONS = {
    ...
    "Game Reset": "ゲームリセット",
    "No actions for card": "このカードで実行できるインストラクションはありません",
    "Multiple actions found. Executing first.": "複数のインストラクションが見つかりました。最初のものを実行します。",
