...
from dm_toolkit.gui.editor.forms.parts.condition_tree_widget import ConditionTreeWidget
...
class ConditionTreeWrapper(ConditionTreeWidget): # Inherits EditorWidgetMixin already
    pass
