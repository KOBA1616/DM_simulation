...
class ActionConverter:
    ...
    def convert(action_data):
        ...
        # 2. DRAW_CARD -> preserve DRAW_CARD semantic for downstream consumers/tests
        ...
        # 7. OTHER
            ...
            # Mekraid: if core parameters are present we can represent it safely,
            # otherwise flag as legacy-warning to prompt user review.
            if 'filter' in act_data or 'value1' in act_data or 'look_count' in act_data:
                cmd['legacy_warning'] = False
            else:
                cmd['legacy_warning'] = True
