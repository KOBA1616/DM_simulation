...
class ModifierEditForm(BaseEditForm):
    ...
    def setup_ui(self):
        ...
        self.connect_signal(self.type_combo, self.type_combo.currentTextChanged, self.update_data)
        ...
        self.connect_signal(self.value_spin, self.value_spin.valueChanged, self.update_data)
        ...
        # But `basic_group` is inside FilterWidget. Let's not access internal members.
    ...
    def update_visibility(self):
        ...
        if mtype == "COST_MODIFIER":
            ...
            # self.filter_widget.setTitle(tr("Cards to Reduce")) # Removed invalid method call
