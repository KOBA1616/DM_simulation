...
class CardTextResources:
    ...
    ACTION_MAP: Dict[str, str] = {
        ...
        "LOCK_SPELL": "{target}は{value1}ターンの間、呪文を唱えられない。",
        "SPELL_RESTRICTION": "{target}は{value1}ターンの間、呪文を唱えられない。",
        "CANNOT_PUT_CREATURE": "{target}は{value1}ターンの間、クリーチャーを出せない。",
        "CANNOT_SUMMON_CREATURE": "{target}は{value1}ターンの間、クリーチャーを召喚できない。",
        "PLAYER_CANNOT_ATTACK": "{target}は{value1}ターンの間、攻撃できない。",
        "REPLACE_CARD_MOVE": "{target}を{from_zone}に置くかわりに{to_zone}に置く。",
