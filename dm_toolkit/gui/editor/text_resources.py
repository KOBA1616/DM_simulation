...
class CardTextResources:
    ...
    ACTION_MAP: Dict[str, str] = {
        ...
        "LOOK_TO_BUFFER": "{source_zone}から{value1}枚を見る。",
        ...
        "LOCK_SPELL": "{target}は呪文を唱えられない。",
        "SPELL_RESTRICTION": "{target}は呪文を唱えられない。",
        "CANNOT_PUT_CREATURE": "{target}はクリーチャーを出せない。",
        "CANNOT_SUMMON_CREATURE": "{target}はクリーチャーを召喚できない。",
        "PLAYER_CANNOT_ATTACK": "{target}は攻撃できない。",
        "REPLACE_CARD_MOVE": "{target}を{from_zone}に置くかわりに{to_zone}に置く。",
