...
class GameWindow(QMainWindow):
    def __init__(self):
        ...
        self.turn_label = QLabel("繧ｿ繝ｼ繝ｳ: 1")
        self.turn_label.setStyleSheet("font-size: 16px; font-weight: bold;")
        self.phase_label = QLabel("繝輔ぉ繝ｼ繧ｺ: START")
        self.active_label = QLabel("謇狗分: P0")
        ...
        # Controls Group
        ctrl_group = QGroupBox("謫堺ｽ・)
        ctrl_layout = QVBoxLayout()
        
        self.start_btn = QPushButton("繧ｷ繝溘Η繝ｬ繝ｼ繧ｷ繝ｧ繝ｳ髢句ｧ・)
        self.start_btn.clicked.connect(self.toggle_simulation)
        ctrl_layout.addWidget(self.start_btn)
        
        self.step_button = QPushButton("繝輔ぉ繝ｼ繧ｺ繧帝ｲ繧√ｋ")
        self.step_button.clicked.connect(self.step_phase)
        ctrl_layout.addWidget(self.step_button)
        
        self.reset_btn = QPushButton("繧ｲ繝ｼ繝繝ｪ繧ｻ繝・ヨ")
        ...
        # Player Mode Group
        mode_group = QGroupBox("繝励Ξ繧､繝､繝ｼ險ｭ螳・)
        mode_layout = QVBoxLayout()
        
        self.p0_human_radio = QRadioButton("P0 (閾ｪ蛻・: 莠ｺ髢・)
        self.p0_ai_radio = QRadioButton("P0 (閾ｪ蛻・: AI")
        ...
        self.p1_human_radio = QRadioButton("P1 (逶ｸ謇・: 莠ｺ髢・)
        self.p1_ai_radio = QRadioButton("P1 (逶ｸ謇・: AI")
        ...
        self.sim_dialog_button = QPushButton("繝舌ャ繝√す繝溘Η繝ｬ繝ｼ繧ｷ繝ｧ繝ｳ")
        ...
        deck_group = QGroupBox("繝・ャ繧ｭ邂｡逅・)
        deck_layout = QVBoxLayout()

        self.load_deck_btn = QPushButton("繝・ャ繧ｭ隱ｭ霎ｼ P0 (閾ｪ蛻・")
        self.load_deck_btn.clicked.connect(self.load_deck_p0)
        deck_layout.addWidget(self.load_deck_btn)

        self.load_deck_p1_btn = QPushButton("繝・ャ繧ｭ隱ｭ霎ｼ P1 (逶ｸ謇・")
        ...
        self.god_view_check = QCheckBox("逾槭・隕也せ (逶ｸ謇九・謇区惆繧定｡ｨ遉ｺ)")
        ...
        # Help Button
        self.help_btn = QPushButton("繝倥Ν繝・/ 隱ｬ譏・)
        ...
        self.p1_hand = ZoneWidget("P1 謇区惆")
        self.p1_mana = ZoneWidget("P1 繝槭リ")
        self.p1_graveyard = ZoneWidget("P1 蠅灘慍")
        self.p1_battle = ZoneWidget("P1 繝舌ヨ繝ｫ繧ｾ繝ｼ繝ｳ")
        self.p1_shield = ZoneWidget("P1 繧ｷ繝ｼ繝ｫ繝・)
        ...
        self.p0_battle = ZoneWidget("P0 繝舌ヨ繝ｫ繧ｾ繝ｼ繝ｳ")
        self.p0_shield = ZoneWidget("P0 繧ｷ繝ｼ繝ｫ繝・)
        self.p0_mana = ZoneWidget("P0 繝槭リ")
        self.p0_graveyard = ZoneWidget("P0 蠅灘慍")
        self.p0_hand = ZoneWidget("P0 謇区惆")
    ...
    def show_help(self):
        help_text = """
        <h2>DM AI 繧ｷ繝溘Η繝ｬ繝ｼ繧ｿ繝ｼ 繧ｬ繧､繝・/h2>
        <p><b>蝓ｺ譛ｬ謫堺ｽ・</b></p>
        <ul>
            <li><b>繧ｷ繝溘Η繝ｬ繝ｼ繧ｷ繝ｧ繝ｳ髢句ｧ・</b> AI蟇ｾAI縲√∪縺溘・AI蟇ｾ莠ｺ髢薙・繧ｲ繝ｼ繝繝ｫ繝ｼ繝励ｒ髢句ｧ九＠縺ｾ縺吶・/li>
            <li><b>繝輔ぉ繝ｼ繧ｺ繧帝ｲ繧√ｋ:</b> 繧ｲ繝ｼ繝繧・繝輔ぉ繝ｼ繧ｺ縺ｾ縺溘・1繧｢繧ｯ繧ｷ繝ｧ繝ｳ謇句虚縺ｧ騾ｲ繧√∪縺吶・/li>
            <li><b>繧ｲ繝ｼ繝繝ｪ繧ｻ繝・ヨ:</b> 迴ｾ蝨ｨ縺ｮ繝・ャ繧ｭ縺ｧ繧ｲ繝ｼ繝繧貞・襍ｷ蜍輔＠縺ｾ縺吶・/li>
        </ul>
        <p><b>繝励Ξ繧､繝､繝ｼ險ｭ螳・</b></p>
        <ul>
            <li><b>莠ｺ髢・</b> 縺ゅ↑縺溘′謫堺ｽ懊＠縺ｾ縺吶ゅき繝ｼ繝峨ｒ繧ｯ繝ｪ繝・け縺励※繝励Ξ繧､/菴ｿ逕ｨ縺励∪縺吶・/li>
            <li><b>AI:</b> AI縺勲CTS・医Δ繝ｳ繝・き繝ｫ繝ｭ譛ｨ謗｢邏｢・峨ｒ菴ｿ逕ｨ縺励※閾ｪ蜍慕噪縺ｫ繝励Ξ繧､縺励∪縺吶・/li>
        </ul>
        <p><b>繝・ャ繧ｭ邂｡逅・</b></p>
        <ul>
            <li><b>繝・ャ繧ｭ讒狗ｯ・</b> 繧ｫ繧ｹ繧ｿ繝繝・ャ繧ｭ繧剃ｽ懈・繝ｻ菫晏ｭ倥＠縺ｾ縺吶・/li>
            <li><b>繝・ャ繧ｭ隱ｭ霎ｼ P0/P1:</b> 菫晏ｭ倥＆繧後◆JSON繝・ャ繧ｭ繧定・蛻・P0)縺ｾ縺溘・逶ｸ謇・P1)縺ｫ隱ｭ縺ｿ霎ｼ縺ｿ縺ｾ縺吶・/li>
        </ul>
        <p><b>繝・ャ繧ｭ讒狗ｯ峨・繧・ｊ譁ｹ:</b></p>
        <ol>
            <li>縲後ョ繝・く讒狗ｯ峨阪・繧ｿ繝ｳ繧偵け繝ｪ繝・け縺励※繧ｨ繝・ぅ繧ｿ繧帝幕縺阪∪縺吶・/li>
            <li>蟾ｦ蛛ｴ縺ｮ繧ｫ繝ｼ繝峨Μ繧ｹ繝医°繧峨ム繝悶Ν繧ｯ繝ｪ繝・け縺ｧ繧ｫ繝ｼ繝峨ｒ繝・ャ繧ｭ縺ｫ霑ｽ蜉縺励∪縺呻ｼ・0譫夲ｼ峨・/li>
            <li>蜿ｳ蛛ｴ縺ｮ繝・ャ繧ｭ繝ｪ繧ｹ繝医°繧峨ム繝悶Ν繧ｯ繝ｪ繝・け縺ｧ繧ｫ繝ｼ繝峨ｒ蜑企勁縺励∪縺吶・/li>
            <li>縲郡ave Deck縲阪・繧ｿ繝ｳ縺ｧJSON繝輔ぃ繧､繝ｫ縺ｨ縺励※菫晏ｭ倥＠縺ｾ縺吶・/li>
        </ol>
        <p><b>譁ｰ繧ｫ繝ｼ繝芽ｿｽ蜉豕・</b></p>
        <ol>
            <li>縲後き繝ｼ繝臥ｷｨ髮・阪・繧ｿ繝ｳ繧偵け繝ｪ繝・け縺励※繧ｨ繝・ぅ繧ｿ繧帝幕縺阪∪縺吶・/li>
            <li>繧ｫ繝ｼ繝牙錐縲√さ繧ｹ繝医√ヱ繝ｯ繝ｼ縲∵枚譏弱↑縺ｩ繧貞・蜉帙＠縲窟dd/Update縲阪〒菫晏ｭ倥＠縺ｾ縺吶・/li>
            <li>繝・・繧ｿ縺ｯ <code>data/cards.csv</code> 縺ｫ菫晏ｭ倥＆繧後∝叉蠎ｧ縺ｫ蜿肴丐縺輔ｌ縺ｾ縺吶・/li>
            <li>窶ｻ隍・尅縺ｪ蜉ｹ譫懶ｼ・繝ｻ繝医Μ繧ｬ繝ｼ莉･螟厄ｼ峨・螳溯｣・↓縺ｯC++繧ｨ繝ｳ繧ｸ繝ｳ縺ｮ譖ｴ譁ｰ縺悟ｿ・ｦ√〒縺吶・/li>
        </ol>
        <p><b>陦ｨ遉ｺ險ｭ螳・</b></p>
        <ul>
            <li><b>逾槭・隕也せ:</b> 繝√ぉ繝・け繧貞・繧後ｋ縺ｨ縲∫嶌謇九・謇区惆縺ｨ繧ｷ繝ｼ繝ｫ繝峨ｒ遒ｺ隱阪〒縺阪∪縺吶・/li>
            <li><b>MCTS View:</b> AI縺ｮ諤晁・・繝ｭ繧ｻ繧ｹ・域爾邏｢譛ｨ・峨ｒ陦ｨ遉ｺ縺励∪縺吶・/li>
        </ul>
        """
        QMessageBox.information(self, "繝倥Ν繝・/ 隱ｬ譏・, help_text)
