...
Purpose:
  ...
  - Does NOT install dependencies. Run setup_gui_review_windows.ps1 -NoLaunch once first.
...
if (-not (Test-Path $pythonExe)) {
  Fail "venv python not found: $pythonExe`nRun: pwsh -File .\\scripts\\setup_gui_review_windows.ps1 -NoLaunch`n(or: pwsh -File .\\scripts\\setup_gui_review_windows.ps1 to setup+launch)"
}
