...
class GameInstance:
    ...
    def resume_processing(self, inputs: List[int]) -> None: ...
    def progress_if_no_actions(self) -> bool: ...
	def step(self) -> bool: ...
    def step_with_reason(self) -> GameStepResult: ...
	def undo(self) -> None: ...
