...
namespace dm::engine {
    ...
    public:
        ...
        static void resolve_play_from_stack(dm::core::GameState& game_state, int stack_instance_id, int cost_reduction, dm::core::SpawnSource spawn_source, const std::map<dm::core::CardID, dm::core::CardDefinition>& card_db);
