...
namespace dm::core {
    ...
    struct ActionDef {
        ...
        bool pay_cost = false;
        bool as_summon = false; // true=SUMMON, false=PUT
...
namespace dm::core {
    ...
    NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE_WITH_DEFAULT(ActionDef, type, scope, filter, value1, value2, str_val, value, optional, target_player, source_zone, destination_zone, target_choice, input_value_key, output_value_key, inverse_target, pay_cost, as_summon, condition, options)
