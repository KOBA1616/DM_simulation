...
namespace dm::core {
    ...
    struct FilterDef {
        ...
        // Spec 5.2.3: Context Reference
        std::optional<std::string> context_val_key;
...
namespace dm::core {
    ...
    NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE_WITH_DEFAULT(FilterDef, owner, zones, types, civilizations, races, min_cost, max_cost, min_power, max_power, is_tapped, is_blocker, is_evolution, is_card_designation, count, selection_mode, selection_sort_key, context_val_key, and_conditions)
