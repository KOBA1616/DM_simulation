...
namespace dm::ai {
    ...
    std::vector<int> ParallelRunner::play_scenario_match(
        ...
        for (int i = 0; i < num_games; ++i) {
            ...
            while (steps < max_steps) {
                 ...
                 if(dm::engine::systems::PhaseSystem::instance().check_game_over(instance.state, res)) {
                    final_res = res;
                    break;
                 }
                 ...
                 if (legal_actions.empty()) {
                     dm::engine::systems::PhaseSystem::instance().next_phase(instance.state, *card_db_);
                     if(dm::engine::systems::PhaseSystem::instance().check_game_over(instance.state, res)) {
                         final_res = res;
                         break;
                     }
            ...
            if (final_res == dm::core::GameResult::NONE) {
                ...
                if (dm::engine::systems::PhaseSystem::instance().check_game_over(instance.state, tmp)) {
                    final_res = tmp;
                }
    ...
    std::vector<int> ParallelRunner::play_deck_matchup(
        ...
        for (int i = 0; i < num_games; ++i) {
            ...
            dm::engine::systems::PhaseSystem::instance().start_game(instance.state, *card_db_);
    ...
    std::map<dm::core::CardID, dm::core::CardStats> ParallelRunner::play_deck_matchup_with_stats(
        ...
        for (int i = 0; i < num_games; ++i) {
            ...
            while (steps < max_steps) {
                 ...
                 dm::core::GameResult res;
                 if(dm::engine::systems::PhaseSystem::instance().check_game_over(instance.state, res)) break;
            ...
            if (final_res_val == dm::core::GameResult::NONE) {
                 dm::engine::systems::PhaseSystem::instance().check_game_over(instance.state, final_res_val);
            }
