...
PYBIND11_MODULE(dm_ai_module, m) {
    ...
    // Trigger/Effect enums and JSON-related defs
    py::enum_<dm::core::TriggerType>(m, "TriggerType")
        .value("NONE", dm::core::TriggerType::NONE)
        .value("ON_PLAY", dm::core::TriggerType::ON_PLAY)
        .value("ON_ATTACK", dm::core::TriggerType::ON_ATTACK)
        .value("ON_DESTROY", dm::core::TriggerType::ON_DESTROY)
        .value("S_TRIGGER", dm::core::TriggerType::S_TRIGGER)
        .value("TURN_START", dm::core::TriggerType::TURN_START)
        .export_values();

    py::enum_<dm::core::EffectActionType>(m, "EffectActionType")
        .value("NONE", dm::core::EffectActionType::NONE)
        .value("DRAW_CARD", dm::core::EffectActionType::DRAW_CARD)
        .value("ADD_MANA", dm::core::EffectActionType::ADD_MANA)
        .value("DESTROY", dm::core::EffectActionType::DESTROY)
        .export_values();

    py::enum_<dm::core::TargetScope>(m, "TargetScope")
        .value("NONE", dm::core::TargetScope::NONE)
        .value("SELF", dm::core::TargetScope::SELF)
        .value("PLAYER_SELF", dm::core::TargetScope::PLAYER_SELF)
        .value("PLAYER_OPPONENT", dm::core::TargetScope::PLAYER_OPPONENT)
        .export_values();

    py::class_<dm::core::ConditionDef>(m, "ConditionDef")
        .def_readwrite("type", &dm::core::ConditionDef::type)
        .def_readwrite("value", &dm::core::ConditionDef::value)
        .def_readwrite("str_val", &dm::core::ConditionDef::str_val);

    py::class_<dm::core::ActionDef>(m, "ActionDef")
        .def_readwrite("type", &dm::core::ActionDef::type)
        .def_readwrite("scope", &dm::core::ActionDef::scope)
        .def_readwrite("value1", &dm::core::ActionDef::value1)
        .def_readwrite("value2", &dm::core::ActionDef::value2)
        .def_readwrite("str_val", &dm::core::ActionDef::str_val);

    py::class_<dm::core::EffectDef>(m, "EffectDef")
        .def_readwrite("trigger", &dm::core::EffectDef::trigger)
        .def_readwrite("actions", &dm::core::EffectDef::actions);

    py::class_<dm::core::CardData>(m, "CardData")
        .def_readonly("id", &dm::core::CardData::id)
        .def_readonly("name", &dm::core::CardData::name)
        .def_readonly("cost", &dm::core::CardData::cost)
        .def_readonly("power", &dm::core::CardData::power)
        .def_readonly("civilizations", &dm::core::CardData::civilizations)
        .def_readonly("effects", &dm::core::CardData::effects);

    // Core Structures
    py::class_<CardKeywords>(m, "CardKeywords")
        .def_property_readonly("g_zero", [](const CardKeywords& k) { return k.has(Keyword::G_ZERO); })
        .def_property_readonly("revolution_change", [](const CardKeywords& k) { return k.has(Keyword::REVOLUTION_CHANGE); })
        .def_property_readonly("mach_fighter", [](const CardKeywords& k) { return k.has(Keyword::MACH_FIGHTER); })
        .def_property_readonly("g_strike", [](const CardKeywords& k) { return k.has(Keyword::G_STRIKE); })
        .def_property_readonly("speed_attacker", [](const CardKeywords& k) { return k.has(Keyword::SPEED_ATTACKER); })
        .def_property_readonly("blocker", [](const CardKeywords& k) { return k.has(Keyword::BLOCKER); })
        .def_property_readonly("slayer", [](const CardKeywords& k) { return k.has(Keyword::SLAYER); })
        .def_property_readonly("double_breaker", [](const CardKeywords& k) { return k.has(Keyword::DOUBLE_BREAKER); })
        .def_property_readonly("triple_breaker", [](const CardKeywords& k) { return k.has(Keyword::TRIPLE_BREAKER); })
        .def_property_readonly("power_attacker", [](const CardKeywords& k) { return k.has(Keyword::POWER_ATTACKER); })
        .def_property_readonly("shield_trigger", [](const CardKeywords& k) { return k.has(Keyword::SHIELD_TRIGGER); })
        .def_property_readonly("evolution", [](const CardKeywords& k) { return k.has(Keyword::EVOLUTION); })
        .def_property_readonly("cip", [](const CardKeywords& k) { return k.has(Keyword::CIP); })
        .def_property_readonly("at_attack", [](const CardKeywords& k) { return k.has(Keyword::AT_ATTACK); })
        .def_property_readonly("at_block", [](const CardKeywords& k) { return k.has(Keyword::AT_BLOCK); })
        .def_property_readonly("at_start_of_turn", [](const CardKeywords& k) { return k.has(Keyword::AT_START_OF_TURN); })
        .def_property_readonly("at_end_of_turn", [](const CardKeywords& k) { return k.has(Keyword::AT_END_OF_TURN); })
        .def_property_readonly("destruction", [](const CardKeywords& k) { return k.has(Keyword::DESTRUCTION); });
