...
#include "engine/infrastructure/data/card_registry.hpp" // Added for dm::engine::infrastructure::CardRegistry
...
void bind_core(py::module& m) {
    ...
    py::enum_<EffectPrimitive>(m, "EffectPrimitive")
        ...
        .value("REVEAL_TO_BUFFER", EffectPrimitive::REVEAL_TO_BUFFER)
    ...
    py::enum_<CommandType>(m, "CommandType")
        ...
        .value("BOOST_MANA", CommandType::BOOST_MANA)
        ...
        .value("PLAYER_MANA_CHARGE", CommandType::PLAYER_MANA_CHARGE)
        ...
        .value("REVEAL_TO_BUFFER", CommandType::REVEAL_TO_BUFFER)
