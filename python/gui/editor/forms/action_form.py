...
class ActionEditForm(QWidget):
    ...
    def setup_ui(self):
        ...
        self.scope_combo.addItems(["PLAYER_SELF", "PLAYER_OPPONENT", "TARGET_SELECT", "ALL_PLAYERS", "RANDOM", "ALL_FILTERED", "NONE"])
        ...
        f_layout.addWidget(QLabel("Count"), 3, 0)
        ...
        self.scope_combo.currentTextChanged.connect(self.update_data)
    ...
    def set_data(self, item):
        ...
        self.type_combo.setCurrentText(data.get('type', 'NONE'))
        self.scope_combo.setCurrentText(data.get('scope', 'NONE'))
    ...
    def populate_input_keys(self):
        ...
        for i in range(row):
            ...
            if out_key:
                ...
                label = f"{out_key} (from #{i} {sib_data.get('type')})"
    ...
    def update_data(self):
        ...
        self.current_item.setText(f"Action: {data['type']}")
