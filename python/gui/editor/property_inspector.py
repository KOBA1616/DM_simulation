...
from gui.editor.forms.card_form import CardEditForm
from gui.editor.forms.effect_form import EffectEditForm
from gui.editor.forms.action_form import ActionEditForm
