...
class TestUnmappedActions(unittest.TestCase):
    def test_high_priority_mappings(self):
        ...
        cmd_block = map_action(act_block)
        ...
        cmd_break = map_action(act_break)
        ...
        cmd_res_bat = map_action(act_res_bat)
        ...
        cmd_res_eff = map_action(act_res_eff)
    ...
    def test_legacy_warning(self):
        ...
        cmd_unknown = map_action(act_unknown)
