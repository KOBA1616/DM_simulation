...
このフォルダはガイド／実装メモを収めています。

- [CAST_SPELL_REPLACE_CARD_MOVE_IMPLEMENTATION.md](CAST_SPELL_REPLACE_CARD_MOVE_IMPLEMENTATION.md)
...
- CAST_SPELL_REPLACE_CARD_MOVE_IMPLEMENTATION.md — アーカイブ済み。詳細は `archive/docs/CAST_SPELL_REPLACE_CARD_MOVE_IMPLEMENTATION.md` を参照。
- GUI_HEADLESS_TESTING_SETUP.md — ヘッドレス環境でのGUIスタブ実装とテスト手順。
	- 主な見出し: 概要 / 環境構築手順 / スタビングのメカニズム / 新しいGUIテストの作成
...
必要に応じて各ファイルからさらに見出しを抽出して目次化できます。
